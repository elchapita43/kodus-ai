#!/usr/bin/env bash
# Bootstrap a Codus tenant for the SSO E2E test:
#   1. Sign up `sso-user@codus-test.com` (creates user + organization).
...
# Local-only test fixtures. `codus-test.com` is a fictitious domain
...
ADMIN_EMAIL="${SSO_E2E_ADMIN_EMAIL:-sso-user@codus-test.com}"

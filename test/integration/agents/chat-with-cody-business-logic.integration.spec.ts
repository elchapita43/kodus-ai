...
describe('ChatWithCodyFromGitUseCase business-logic integration', () => {
    let chatUseCase: ChatWithCodyFromGitUseCase;
    ...
    beforeEach(() => {
        ...
        chatUseCase = new ChatWithCodyFromGitUseCase(
    ...
    it('handles the business-logic flow through the real business-rules provider', async () => {
        const params = {
            ...
            payload: {
                ...
                comment: {
                    id: 123,
                    body: '@cody -v business-logic https://elchapita43.atlassian.net/jira/software/c/projects/KC/boards/2?selectedIssue=KC-1441',
                },
                sender: {
                    id: 'user-1',
                    login: 'alice',

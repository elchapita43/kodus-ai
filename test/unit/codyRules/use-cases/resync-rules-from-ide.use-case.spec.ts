...
import { ValidateRuleFileReferencesUseCase } from '@libs/codyRules/application/use-cases/validate-rule-file-references.use-case';
...
describe('ResyncRulesFromIdeUseCase', () => {
    ...
    let codyRulesSyncServiceMock: { syncRepositoryMain: jest.Mock };
    ...
    it('passes an optional path to manual IDE resync', async () => {
        ...
        expect(
            codyRulesSyncServiceMock.syncRepositoryMain,

...
// nothing and the cody-rules agent silently reviewed without them. Caught
// live by the cody-rules-file-sync E2E on the hotfix droplet.
describe('CodyRulesAgentProvider.matchesPathPattern', () => {
    const provider = Object.create(
        CodyRulesAgentProvider.prototype,
    ) as CodyRulesAgentProvider;

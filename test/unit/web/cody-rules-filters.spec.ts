import {
    ...
    matchesTextQuery,
    type ListFilters,
} from "../../../apps/web/src/core/utils/cody-rules/apply-filters";
...
describe("isOrphanAutoSyncRule", () => {
    ...
    it("excludes pinnedSync rules (still synced via @cody-sync)", () => {
...
describe("matchesSyncErrorsFilter", () => {
    const { matchesSyncErrorsFilter } = jest.requireActual<
        typeof import("../../../apps/web/src/core/utils/cody-rules/apply-filters")
    >("../../../apps/web/src/core/utils/cody-rules/apply-filters");

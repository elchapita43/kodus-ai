import {
    inferRuleOrigin,
    isIdeRuleSource,
} from "../../../apps/web/src/core/utils/cody-rules/infer-origin";
...
describe("inferRuleOrigin", () => {
    ...
    it('returns "Cody-generated" when origin is "generated", ignoring sourcePath', () => {
        expect(
            inferRuleOrigin({
                sourcePath: null,
                origin: "generated",

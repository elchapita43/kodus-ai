...
- POST http://localhost:3001/cody-rules/create-or-update → 400
- POST http://localhost:3001/cody-rules/add-library-cody-rules → 400
- POST http://localhost:3001/cody-rules/generate-cody-rules → 400
- POST http://localhost:3001/cody-rules/change-status-cody-rules → 400
- POST http://localhost:3001/cody-rules/sync-ide-rules → 500
- POST http://localhost:3001/cody-rules/fast-sync-ide-rules → 500
- POST http://localhost:3001/cody-rules/review-fast-ide-rules → 500
- POST http://localhost:3001/cody-rules/resync-ide-rules → 500
...
- GET http://localhost:3001/parameters/generate-codus-config-file?teamId=c33ef663-70e7-4f43-9605-0bbef979b8e0&repositoryId=1135722979&directoryId= → 500
...
- GET http://localhost:3001/pull-requests/executions?repositoryId=1135722979&repositoryName=codus-extension&limit=20&page=1&hasSentSuggestions=false&pullRequestTitle={{pullRequestTitle}}&pullRequestNumber={{pullRequestNumber}}&teamId=c33ef663-70e7-4f43-9605-0bbef979b8e0 → 400

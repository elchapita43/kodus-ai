...
//   node evals/cody-rules/decompose-rules.js [--model=gpt-5.4-mini]
const fs = require('fs');
...
async function main() {
    ...
    const { compileRuleDetector, makeLLMRunCompiler } = require('../../libs/code-review/infrastructure/agents/collaborators/cody-rules-detector.compiler.ts');

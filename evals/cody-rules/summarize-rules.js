...
const ROOT = '/Users/juniorsartori/Projects/Cody/codus-ai';
...
const IN = path.join(ROOT, 'evals/cody-rules/rails-convention-cases-all.json');
const OUT = path.join(ROOT, 'evals/cody-rules/rails-convention-cases-summarized-v2.json');
const AUDIT = '/private/tmp/claude-501/-Users-juniorsartori-Projects-Cody-codus-ai/f29e42c9-7526-423f-a336-6aca036ad54b/scratchpad/summaries-audit-v2.txt';
const THRESHOLD = 500;

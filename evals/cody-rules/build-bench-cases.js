// Generate cody-rules cases from REAL benchmark PR diffs.
//
...
//
//   node evals/cody-rules/build-bench-cases.js   → writes bench-cases.json
//
...
console.log(`\nWrote ${cases.length} bench cases → evals/cody-rules/bench-cases.json`);

 ...
 *
 * Reads evals/cody-rules/prod-rules.json (gitignored — customer data). Nothing
...
const { compileRuleDetector, makeLLMRunCompiler } = require(
    '../../libs/code-review/infrastructure/agents/collaborators/cody-rules-detector.compiler.ts',
);

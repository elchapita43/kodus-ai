// Semantic-judge eval on REAL prod cody-rules (issue #1449).
//
...
//
//   node evals/cody-rules/prod-rules-judge-eval.js [--model=kimi-k2.7-code] [--temp=1] [--conc=2] [--limit=N] [--dataset=prod-rules]
//
// Input: evals/cody-rules/prod-rules.json — the BigQuery export (array of rule

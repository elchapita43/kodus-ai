// Harvest REAL cody-rules cases from live GitHub PRs.
//
...
//
//   node evals/cody-rules/harvest-github-cases.js [--repos a/b,c/d] [--per 25] [--want 12]
//
...
console.log(`\nWrote ${cases.length} GitHub cases → evals/cody-rules/github-cases.json`);

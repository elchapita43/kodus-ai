// Cody-rules adherence — SHARDED SINGLE-SHOT EXPERIMENT (issue #1449).
//
...
//
//   node evals/cody-rules/sharded-experiment.js [--model=gpt-5.4-mini] [--runs=1] [--limit=N] [--conc=4]
//
...
async function main() {
    ...
    console.log(`\n════ cody-rules — SHARDED SINGLE-SHOT (${MODELKEY}, ${RUNS} run/case, 1 call/file, no tools) ════`);

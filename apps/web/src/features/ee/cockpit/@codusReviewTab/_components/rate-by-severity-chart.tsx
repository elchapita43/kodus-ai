    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <p className="text-text-tertiary px-1 text-[11px]">
                {source === "native"
                    ? "Excluding Cody Rules — their severity is set on the rule, not by Codus's risk analysis."
                    : "Includes Cody Rules. Switch to “Codus only” for Codus's own severity calibration."}

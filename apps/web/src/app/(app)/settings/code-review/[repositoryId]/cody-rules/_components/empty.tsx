...
import { useSuspenseFindLibraryCodyRules } from "@services/codyRules/hooks";
import { Plus } from "lucide-react";

import { useCodeReviewRouteParams } from "../../../../_hooks";

const NoItems = () => {
    const rules = useSuspenseFindLibraryCodyRules();
...
const NoItemsViewMore = () => (
    <Link href="/library/cody-rules/featured" className="w-full">
        <Button
            decorative
            size="lg"
            variant="helper"
...
export const CodyRulesEmptyState = ({
    canEdit,
    entityLabel = "rule",
    showDiscovery = true,
    onAddNewRule,
}: CodyRulesEmptyStateProps) => {
    const title =
        entityLabel === "memory"

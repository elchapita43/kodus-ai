 ...
 * connected repositories as sources of GLOBAL Cody Rules. Access depends on the
 * org's plan:
...
export const GlobalRulesSourceSetting = () => {
    ...
    const canEdit = usePermission(Action.Create, ResourceType.CodyRules);
    ...
    const header = (
        <Section.Header>
            ...
            <Section.Description>
                ...
                global Cody Rules. Global rules apply to every repository during
                code review.
            </Section.Description>
        </Section.Header>
    );
    ...
    return (
        <Card>
            ...
            <ConfirmModal
                ...
                description={
                    `The global Cody Rules imported from ` +

...
type CodyRulesNoMatchesProps = {
    entityLabel?: "rule" | "memory";
    onClearFilters: () => void;
};

// Shown when there ARE rules in the system but the active filters narrowed
// the list down to nothing. Distinct from CodyRulesEmptyState (no rules at
...
export const CodyRulesNoMatches = ({
    entityLabel = "rule",
    onClearFilters,
}: CodyRulesNoMatchesProps) => {

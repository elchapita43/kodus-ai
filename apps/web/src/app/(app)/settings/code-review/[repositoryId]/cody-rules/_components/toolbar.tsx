...
import type { InferredRuleOrigin } from "src/core/utils/cody-rules/infer-origin";
                ...
                <section className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <Checkbox
                                id="origin-cody-sync"
                                checked={listFilters.codySync}
                                onCheckedChange={(checked) =>
                                    onListFiltersChange({
                                        ...listFilters,
                                        codySync: Boolean(checked),
                                    })
                                }
                            />
                            <Label htmlFor="origin-cody-sync">@cody-sync</Label>
                        </div>
                    </div>
                </section>
            )}

...
import { CodyRulesListSkeleton } from "./list-skeleton";

// Page-shell skeleton for Cody Rules. Mirrors the real layout so the
...
export const CodyRulesPageSkeleton = () => {
    return (
        <Page.Root>
            <Page.Header>

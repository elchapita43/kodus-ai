...
export const CodyKnowledgeApprovalSetting = () => {
                        ...
                        <Section.Root>
                            <Section.Header>
                                <div className="flex items-center gap-2">
                                    <Section.Title>
                                        Cody knowledge approval
                                    </Section.Title>
                                    {config?.codyKnowledgeApproval?.enabled !==
                                        undefined && (
                                        <OverrideIndicator
                                            initialState={
                                                config.codyKnowledgeApproval
                                                    .enabled
                                            }
                            ...
                            <Section.Content className="text-text-secondary text-sm font-normal">
                                When enabled, Cody-generated rules and memories

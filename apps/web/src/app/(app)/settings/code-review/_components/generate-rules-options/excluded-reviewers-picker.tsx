 ...
 * comments Cody should NOT learn from. Empty = learn from everyone. Reviewers
    ...
    const [handleSave, { loading: isSaving }] = useAsyncAction(async () => {
        try {
            await createOrUpdateCodeReviewParameter(
                { codyLearningExcludedReviewers: pending },
                teamId,
                repositoryId,
            );
    ...
    return (
        <div className="mt-1 mb-2 ml-2 flex flex-col gap-1">
            <span className="text-text-secondary text-xs">
                Exclude specific developers so Cody doesn&apos;t learn rules

...
const CODY_AUTHOR: Author = {
    name: "cody-ci",
    avatar: "/assets/images/logo-nav.svg",
    isBot: true,
};

type CodyReviewPreviewProps = {
    mode: ReviewMode;
    author?: Author;
    comment?: string;
    className?: string;
...
export function CodyReviewPreviewComparison({
    className,
    ...
    return (
        <div className={cn("flex flex-col gap-4", className)}>
            <div className="flex flex-col gap-2">
                ...
                <CodyReviewPreview mode="inline" comment={inlineComment} />
            </div>
            <div className="flex flex-col gap-2">
                <div className="text-text-secondary flex items-center gap-2 text-xs">
                ...
                <CodyReviewPreview mode="pr-comment" comment={prComment} />
            </div>
        </div>
    );
}

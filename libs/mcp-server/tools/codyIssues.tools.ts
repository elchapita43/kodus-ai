...
@Injectable()
export class CodyIssuesTools {
    private readonly logger = createLogger(CodyIssuesTools.name);
    constructor(
    ...
    createCodyIssue(): McpToolDefinition {
        const name = 'CODUS_CREATE_CODY_ISSUE';
        const inputSchema = z.strictObject({
            ...
            originalCodyCommentId: z
                .number()
                .describe(
                    'commentId of original Cody comment though which the discussion got started ',
                ),
            pullRequestNumber: z
                .number()
        ...
        return {
            name: name,
            description: 'Create a new Cody Issue manually via MCP',
            inputSchema,
            ...
            execute: wrapToolHandler(
                async (args: InputType) => {
                    ...
                    const suggestionFromArgs =
                        typeof args.originalCodyCommentId !== 'undefined' &&
                        resolvedPrAuthor
                            ? {
                                  id: args.originalCodyCommentId.toString(),
    ...
    listCodyIssues(): McpToolDefinition {
        ...
        return {
            ...
            description: 'List Cody Issues with optional filters',
            inputSchema,
            outputSchema: z.object({
                success: z.boolean(),
                count: z.number(),
    ...
    getCodyIssueDetails(): McpToolDefinition {
        const inputSchema = z.object({
        ...
        return {
            ...
            description: 'Get a Cody Issue by id',
            inputSchema,
            outputSchema: z.object({
                success: z.boolean(),
    ...
    updateCodyIssueStatus(): McpToolDefinition {
        const inputSchema = z.object({
            issueId: z.string(),
    ...
    updateCodyIssueCategory(): McpToolDefinition {
        const inputSchema = z.object({
            issueId: z.string(),
            label: z.enum(LabelType),
        });
    ...
    deleteCodyIssue(): McpToolDefinition {
    ...
    getAllTools(): McpToolDefinition[] {
        return [
            this.createCodyIssue(),
            this.listCodyIssues(),
            this.getCodyIssueDetails(),
            this.updateCodyIssueStatus(),
            this.updateCodyIssueCategory(),
            this.deleteCodyIssue(),
        ];
    }
}

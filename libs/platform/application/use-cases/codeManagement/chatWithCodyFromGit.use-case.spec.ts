...
import { ChatWithCodyFromGitUseCase } from './chatWithCodyFromGit.use-case';

describe('ChatWithCodyFromGitUseCase', () => {
    let useCase: ChatWithCodyFromGitUseCase;
    ...
    beforeEach(() => {
        ...
        useCase = new ChatWithCodyFromGitUseCase(
        ...
        await useCase.execute({
            ...
            payload: {
                ...
                issue: {
                    ...
                    pull_request: {
                        url: 'https://api.github.com/repos/codus/codus-extension/pulls/132',
                    },
                },
                pull_request: {
                    head: {
                ...
                comment: {
                    id: 123,
                    body: '@cody -v business-logic validate this change',
                },
                sender: {
                    id: 'user-1',
                    login: 'alice',
        ...
        expect(
            ...
            expect.objectContaining({
                ...
                prepareContext: expect.objectContaining({
                    userQuestion:
                        '@cody -v business-logic validate this change',
    ...
    it('passes the original Jira URL command body to business logic validation', async () => {
        ...
        await useCase.execute({
            ...
            payload: {
                ...
                comment: {
                    id: 123,
                    body: `@cody -v business-logic ${jiraUrl}`,
                },
                sender: {
                    id: 'user-1',
                    login: 'alice',
        ...
        expect(
            ...
            expect.objectContaining({
                prepareContext: expect.objectContaining({
                    userQuestion: `@cody -v business-logic ${jiraUrl}`,
                    pullRequestDescription: 'PR description body',
                    repository: expect.objectContaining({
                        name: 'codus-extension',
                        owner: 'codus',
        ...
        const conversationPayload = () =>
            ({
                ...
                payload: {
                    ...
                    comment: {
                        id: 123,
                        body: '@cody can we use optional chaining here?',
                    },
                    sender: {
                        id: 'user-1',
                        login: 'alice',

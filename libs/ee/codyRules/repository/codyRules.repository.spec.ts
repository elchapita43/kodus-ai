import { CodyRulesRepository } from './codyRules.repository';
 ...
 */
describe('CodyRulesRepository.updateRulesStatusByFilter', () => {
    let model: any;
    let repo: CodyRulesRepository;
    ...
    beforeEach(() => {
        ...
        repo = new CodyRulesRepository(model as any, {} as any);
    });

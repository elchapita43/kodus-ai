...
/**
 * Creates the `codus_cross_process_events` table used by
 ...
 * TypeORM raised `relation "codus_cross_process_events" does not exist` at
    ...
    implements MigrationInterface
{
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE IF NOT EXISTS "codus_cross_process_events" (
        ...
        //   DELETE FROM codus_cross_process_events
        ...
        // on every reconnect).
        await queryRunner.query(`
            CREATE INDEX IF NOT EXISTS "IDX_codus_cross_process_events_created_at"
                ON "codus_cross_process_events" ("created_at")
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `DROP INDEX IF EXISTS "IDX_codus_cross_process_events_created_at"`,
        );
        await queryRunner.query(
            `DROP TABLE IF EXISTS "codus_cross_process_events"`,
        );
    }
}

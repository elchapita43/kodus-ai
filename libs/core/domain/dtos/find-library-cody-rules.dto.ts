...
import { CodyRuleFilters } from '@libs/core/infrastructure/config/types/general/codyRules.type';
...
export class FindLibraryCodyRulesDto
    extends PaginationDto
    implements CodyRuleFilters
{
    ...
    @IsOptional()
    @IsBoolean()
    @Transform(FindLibraryCodyRulesDto.transformToBoolean)
    @ApiPropertyOptional()

...
import { CodyIssuesManagementService } from './codyIssuesManagement.service';
...
import { CODY_ISSUES_ANALYSIS_SERVICE_TOKEN } from '@libs/ee/codeBase/codyIssuesAnalysis.service';
...
describe('CodyIssuesManagementService', () => {
    let service: CodyIssuesManagementService;
    ...
    let codyIssuesAnalysisServiceMock: any;
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                },
                {
                    ...
                    useValue: codyIssuesAnalysisServiceMock,
                },
                {
        ...
        service = module.get<CodyIssuesManagementService>(
            CodyIssuesManagementService,
        );
    });

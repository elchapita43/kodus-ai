...
@Schema({
    collection: 'codyRules',
    timestamps: true,
    autoIndex: true,
})
export class CodyRulesModel {
    ...
    public rules: ICodyRule[];
}

export const CodyRulesSchema = SchemaFactory.createForClass(CodyRulesModel);
...
CodyRulesSchema.index({ 'rules.uuid': 1 });

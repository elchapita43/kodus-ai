...
} from '@libs/codyRules/domain/contracts/ruleLike.repository.contract';
import { IRuleLikeService } from '@libs/codyRules/domain/contracts/ruleLike.service.contract';
import {
    RuleFeedbackType,
    RuleLikeEntity,
} from '@libs/codyRules/domain/entities/ruleLike.entity';

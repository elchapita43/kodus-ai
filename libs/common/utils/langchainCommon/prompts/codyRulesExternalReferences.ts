...
export const codyRulesDetectReferencesSchema = z.object({
    references: z.array(
        z.object({
            fileName: z.string(),
...
export type CodyRulesDetectReferencesSchema = z.infer<
    typeof codyRulesDetectReferencesSchema
>;

export const prompt_codyrules_detect_references_system = () => {
...
export const prompt_codyrules_detect_references_user = (payload: {
    rule: string;
}) => {

...
// LLM output schema — intentionally NOT derived from codyRuleSchema: that is
...
export const prompt_CodyRulesGeneratorSystem = () => `
...
export const prompt_CodyRulesGeneratorUser = (payload: {
    comments: UncategorizedComment[];
    rules: LibraryCodyRule[];
    memories?: Array<{
        title?: string;
        rule?: string;
    }>;
...
export const codyRulesGeneratorDuplicateFilterSchema = z.object({
    uuids: z.array(z.string()),
});

export const prompt_CodyRulesGeneratorDuplicateFilterSystem = () => `
...
export const prompt_CodyRulesGeneratorDuplicateFilterUser = (payload: {
    existingRules: LibraryCodyRule[];
    newRules: Array<Partial<ICodyRule>>;
}) => `
existing rules:
...
export const codyRulesGeneratorQualityFilterSchema = z.object({
    uuids: z.array(z.string()),
});

export const prompt_CodyRulesGeneratorQualityFilterSystem = () => `
...
export const prompt_CodyRulesGeneratorQualityFilterUser = (payload: {

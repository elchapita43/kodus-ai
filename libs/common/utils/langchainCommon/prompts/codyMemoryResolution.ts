...
export const codyMemoryResolutionSchema = z.object({
...
export type CodyMemoryResolution = z.infer<typeof codyMemoryResolutionSchema>;

export const prompt_codyMemoryResolution_system =
...
export const prompt_codyMemoryResolution_user = (payload: {
    incomingMemory: {
        title: string;
        rule: string;
        repositoryId?: string;

import { CodyRuleHealthState, CodyRuleUsageRow } from '../types';
...
export function computeRuleState(usage: CodyRuleUsageRow | undefined): {
    state: CodyRuleHealthState;
    usage: Omit<CodyRuleUsageRow, 'ruleId'>;
} {
    ...
    let state: CodyRuleHealthState = 'healthy';

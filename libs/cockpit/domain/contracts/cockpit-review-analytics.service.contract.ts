...
/**
 * Contract for the "Codus Review" warehouse analytics. Consumers depend on
...
export interface ICockpitReviewAnalyticsService {
    ...
    getCodyRulesUsage(q: CockpitRangeQuery): Promise<CodyRuleUsageRow[]>;
    /**
     ...
     * without a second round-trip — Cody rules only carry the external

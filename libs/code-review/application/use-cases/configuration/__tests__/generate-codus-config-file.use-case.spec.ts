...
import { GenerateCodusConfigFileUseCase } from '../generate-codus-config-file.use-case';

describe('GenerateCodusConfigFileUseCase', () => {
    const teamId = 'team-1';
    ...
    const makeUseCase = () => {
        ...
        const useCase = new GenerateCodusConfigFileUseCase(

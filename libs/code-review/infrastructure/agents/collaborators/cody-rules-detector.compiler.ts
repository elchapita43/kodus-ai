/**
 * T0 detector compiler + gate for cody-rules (issue #1449).
 *
 ...
 * on evals/cody-rules/detector-compiler-eval.js (98% behavioral recall, 6/6
...
import { ruleAppliesToFile } from '@libs/code-review/infrastructure/agents/collaborators/cody-rules-sharded.judge';
...
export function buildCompilerUserPrompt(rule: Partial<ICodyRule>): string {
    const parts = [
        `<Rule>`,
        `Title: ${rule.title}`,
...
export type DetectorPlan = ICodyRuleDetector;

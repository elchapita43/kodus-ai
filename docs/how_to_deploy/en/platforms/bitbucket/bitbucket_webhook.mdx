...
description: "Manually create the Bitbucket webhook when automatic registration didn't happen, and pick the pull request triggers Codus actually consumes."
icon: webhook
---
...
<Note>
  Codus only consumes Pull Request events — `created`, `updated`, `merged`, `declined`, and

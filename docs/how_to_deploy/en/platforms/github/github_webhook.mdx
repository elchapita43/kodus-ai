...
description: "Manually create the GitHub webhook when automatic registration didn't happen, and select the three events Codus consumes."
icon: webhook
---
...
<Note>
  These are the only three events Codus consumes. Selecting extras (pushes, pull request

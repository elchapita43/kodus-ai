---
title: "Updating"
description: "Update your Codus installation."
icon: "arrow-up"
---
...
<Note>
  ...
  sent with `pnpm run telemetry:preview`, or set `CODUS_TELEMETRY_DISABLED=true`
  to opt out. Full schema and policy in
  [Anonymous Telemetry](/how_to_deploy/en/deploy_codus/telemetry).
</Note>

To update your Codus installation to the latest version:

```bash
# Navigate to your Codus installation directory
cd codus-installer

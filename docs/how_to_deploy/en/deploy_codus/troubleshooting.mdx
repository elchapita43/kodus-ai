...
description: "Solve common issues with Codus."
icon: "headset"
---
...
### "Edge Runtime errors in `codus-web` logs"
...
1. Update to the latest `codus-web` image (re-run the installer or run `docker-compose pull codus-web` and `docker-compose up -d`).
...
- [GitHub Issues](https://github.com/elchapita43/codus-installer/issues)

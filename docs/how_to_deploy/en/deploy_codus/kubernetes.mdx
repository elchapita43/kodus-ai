...
description: "Deploy Codus on Kubernetes or OpenShift with the official Helm charts."
icon: "dharmachakra"
---

Prefer a cluster over a single VM? Codus ships **Helm charts** for Kubernetes and
OpenShift in the [codus-installer](https://github.com/elchapita43/codus-installer)
repository. This page is the overview — the charts'
[README](https://github.com/elchapita43/codus-installer/blob/main/charts/README.md)
...
`imageTag` pins the Codus release for the whole stack (like Docker Compose
...
helm install codus . -f values.yaml -f values-openshift.yaml \
  -n codus --create-namespace --set imageTag=<version>
```
...
- **Health check** — `../../scripts/doctor-k8s.sh -n codus` inspects workloads, config,
  and the real health endpoints.

<Card title="Full Helm reference" icon="github" href="https://github.com/elchapita43/codus-installer/blob/main/charts/README.md">

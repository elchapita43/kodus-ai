...
description: "Crie o OAuth App do GitHub que habilita o \"Sign in with GitHub\" para seus usuários — separado do GitHub App usado no code review."
icon: github
---

Use isto se quiser que os usuários entrem no Codus com GitHub. Isso é separado da integração com GitHub App usada para automação de revisão de código e webhooks.
...
Após criar o app, copie as credenciais do GitHub e adicione ao seu ambiente do Codus:

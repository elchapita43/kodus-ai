...
description: "Crie o OAuth App do GitLab que habilita o \"Sign in with GitLab\" para seus usuários — separado da integração de webhook usada no code review."
icon: gitlab
---

Use isto se quiser que os usuários entrem no Codus com GitLab. Isso é separado da integração de webhook do GitLab usada para automação de revisão de código.
...
Após criar o app, copie as credenciais do GitLab e adicione ao seu ambiente do Codus:

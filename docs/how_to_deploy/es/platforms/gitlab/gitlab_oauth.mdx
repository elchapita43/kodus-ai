...
description: "Crea la OAuth App de GitLab que habilita el \"Sign in with GitLab\" para tus usuarios — separada de la integración de webhook usada en la revisión."
icon: gitlab
---

Usa esto si deseas que los usuarios inicien sesión en Codus con GitLab. Esto es independiente de la integración de webhooks de GitLab utilizada para la automatización de revisiones de código.
...
Después de crear la app, copia las credenciales de GitLab y agrégalas a tu entorno de Codus:

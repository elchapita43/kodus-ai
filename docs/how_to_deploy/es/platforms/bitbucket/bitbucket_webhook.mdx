...
description: "Crea manualmente el webhook de Bitbucket cuando el registro automático no ocurrió, y marca solo los triggers de pull request que Codus consume."
icon: webhook
---
...
<Note>
  Codus solo consume eventos de Pull Request — `created`, `updated`, `merged`, `declined` y

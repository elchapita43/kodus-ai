...
description: "Despliega Codus en Kubernetes u OpenShift con los Helm charts oficiales."
icon: "dharmachakra"
---

¿Prefieres un clúster en lugar de una sola VM? Codus ofrece **Helm charts** para
Kubernetes y OpenShift en el repositorio
[codus-installer](https://github.com/elchapita43/codus-installer). Esta página es la
visión general — el [README](https://github.com/elchapita43/codus-installer/blob/main/charts/README.md)
...
`imageTag` fija la versión de Codus para todo el stack (como el `IMAGE_TAG` de
...
helm install codus . -f values.yaml -f values-openshift.yaml \
  -n codus --create-namespace --set imageTag=<versión>
```
...
- **Health check** — `../../scripts/doctor-k8s.sh -n codus` inspecciona workloads,
  configuración y los endpoints reales de salud.

<Card title="Referencia completa de Helm" icon="github" href="https://github.com/elchapita43/codus-installer/blob/main/charts/README.md">

...
Uma vez conectado, o Codus pode buscar automaticamente o contexto das tarefas durante as revisões.
...
A qualidade da validação depende inteiramente da qualidade das descrições das suas tarefas. O Codus classifica o contexto das tarefas como:
...
1. **Revisão de qualidade de código** — segurança, desempenho, estilo (Codus padrão)
...
- Se um PR intencionalmente não cobre todos os critérios (entrega faseada), anote isso na descrição do PR para que o Cody possa levar em conta

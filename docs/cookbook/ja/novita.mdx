...
description: "NovitaのモデルをCodusで使用する方法"
icon: "server"
---
...
3. 「Add New Key」をクリックして「Codus」または任意の名前を入力する
4. 「Confirm」をクリックする
...
<Tip>
  SSLセットアップ、監視、高度な設定の詳細については、[完全なデプロイガイド](https://docs.kodus.io/how_to_deploy/ja/deploy_codus/generic_vm) を参照してください。
</Tip>

...
Once connected, Codus can automatically fetch task context during reviews.
...
The quality of validation depends entirely on the quality of your task descriptions. Codus classifies task context as:
...
1. **Code quality review** — security, performance, style (standard Codus)
...
- If a PR intentionally doesn't cover all criteria (phased delivery), note it in the PR description so Cody can account for it

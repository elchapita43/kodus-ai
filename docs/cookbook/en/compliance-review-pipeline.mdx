...
description: "Configure Cody Rules and Memories to enforce audit trail, data handling, and access control requirements."
icon: "file-shield"
---
...
Start by teaching Cody the high-level compliance principles:

...
description: "Set up Cody Rules focused on OWASP top 10, secrets detection, and secure coding patterns."
icon: "shield-halved"
---
...
This gives you Codus' built-in security checks. The rules below add your team's specific security policies on top.
...
1. Enable **Request Changes** in PR Workflow settings so Cody requests changes when critical issues are found
...
For more on configuring rules, see [Cody Rules](/how_to_use/en/code_review/configs/cody_rules).

---
title: "Codus + flujo de trabajo de sprint"
...
Una vez conectada, Codus puede obtener automáticamente el contexto de la tarea durante las revisiones.
...
La calidad de la validación depende completamente de la calidad de las descripciones de tus tareas. Codus clasifica el contexto de la tarea como:
...
```
@cody -v business-logic https://elchapita43.atlassian.net/browse/KC-1292
```
...
```
@cody remember: every PR must be linked to a Jira ticket.
PRs without a linked ticket should be flagged.
```

```
@cody remember: acceptance criteria marked as "out of scope"
...
1. **Revisión de calidad de código** — seguridad, rendimiento, estilo (Codus estándar)
...
- Si un PR intencionalmente no cubre todos los criterios (entrega por fases), anótalo en la descripción del PR para que Cody pueda tenerlo en cuenta

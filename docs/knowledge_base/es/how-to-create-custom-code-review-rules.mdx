...
- **Generación automática** — Cody sugiere reglas basadas en tu historial de revisiones

Para la referencia completa, consulta [Cody Rules](/how_to_use/es/code_review/configs/cody_rules).

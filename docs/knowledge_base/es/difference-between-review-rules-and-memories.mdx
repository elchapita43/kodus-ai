...
description: "Comprende cuándo usar Reglas de Revisión versus Memorias en Cody para obtener los mejores resultados en la revisión de código."
---

En la interfaz de Cody Rules configuras dos cosas distintas, y saber cuándo usar cada una hace que tus revisiones de código sean más efectivas.

Una regla práctica:

- **Las Memorias** le enseñan a Cody cómo funciona tu código para que las futuras revisiones y sugerencias sean más relevantes.
- **Las Reglas de Revisión** le dicen a Cody qué debe marcar cuando un PR no cumple tus estándares.
...
Las Memorias son **instrucciones contextuales persistentes** que se inyectan en todas las interacciones — revisiones de código, conversaciones y sugerencias de IA. Representan el conocimiento de fondo que Cody debe conservar sobre tu código, tus convenciones y tus preferencias.
...
- Mejoran futuras sugerencias al darle a Cody contexto específico del repositorio
- Se crean mediante conversación (`@cody remember: ...`) o manualmente en la interfaz
- Con alcance a directorio, repositorio u organización
- Cody deduplica automáticamente y resuelve conflictos entre memorias
...
Para más detalles, consulta [Cody Rules](/how_to_use/es/code_review/configs/cody_rules).

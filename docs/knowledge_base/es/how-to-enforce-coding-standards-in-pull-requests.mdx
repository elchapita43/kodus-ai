...
## Cómo funciona con Codus

Codus te permite definir **Cody Rules** — instrucciones personalizadas que se verifican automáticamente durante cada revisión de código. Existen dos tipos:
...
- Las **Memories** son convenciones persistentes que Cody aplica en todas las interacciones — revisiones de código, conversaciones y sugerencias
...
- **Reglas de repositorio** — define reglas en archivos markdown directamente en tu repositorio (`codus/rules/`)
- **Generación automática de reglas** — deja que Cody analice 3 meses de historial de revisiones y sugiera reglas basadas en los patrones de tu equipo
...
4. Cody lo aplicará en cada PR futuro

Para más detalles, consulta la [documentación de Cody Rules](/how_to_use/es/code_review/configs/cody_rules).

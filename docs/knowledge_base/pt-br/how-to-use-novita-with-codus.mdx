...
description: "Aprenda como usar os modelos da Novita com o Codus"
icon: "server"
---
...
3. Clique em "Adicionar Nova Chave" e preencha com 'Codus' ou qualquer nome que desejar
...
# ou API_GITLAB_CODE_MANAGEMENT_WEBHOOK="https://codus-api.yourdomain.com/gitlab/webhook"
# ou GLOBAL_BITBUCKET_CODE_MANAGEMENT_WEBHOOK="https://codus-api.yourdomain.com/bitbucket/webhook"
```
...
<Tip>
  Para informações detalhadas sobre configuração de SSL, monitoramento e configurações avançadas, consulte nosso [guia completo de implantação](https://docs.kodus.io/how_to_deploy/pt-br/deploy_codus/generic_vm).
</Tip>

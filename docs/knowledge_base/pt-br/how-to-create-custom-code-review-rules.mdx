...
- **Geração automática** — o Cody sugere regras baseadas no seu histórico de revisões

Para a referência completa, consulte [Regras do Cody](/how_to_use/pt-br/code_review/configs/cody_rules).

...
description: "Bring your own API key and choose your preferred LLM provider for AI-powered code review with Codus."
---

Yes. Codus supports Bring Your Own Key (BYOK) on every plan, letting you use your preferred LLM provider. You pay the provider directly — Codus never marks up tokens and never sees your key in plain text.
...
3. Paste your API key and click **Test & save** — Codus validates the key with a cheap metadata call before persisting
...
If you self-host Codus, you can point BYOK at self-hosted or aggregator endpoints like:

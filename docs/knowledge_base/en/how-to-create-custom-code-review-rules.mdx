...
- **Auto-generation** — Cody suggests rules based on your review history

For the full reference, see [Cody Rules](/how_to_use/en/code_review/configs/cody_rules).

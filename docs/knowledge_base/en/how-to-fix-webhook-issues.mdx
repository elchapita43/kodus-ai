...
description: "Debug and resolve webhook connectivity problems between your Git provider and Codus."
---

Webhooks are how Codus knows when a PR is opened or updated. If they're not working, reviews won't trigger.
...
If you changed your Codus deployment URL, update the webhook URL in your Git provider settings.
...
If Codus is behind a firewall, ensure your Git provider's IP ranges can reach the webhook endpoint.

### Webhook was deleted

Re-register the webhook by going through the Codus setup flow again, or manually add the webhook URL.

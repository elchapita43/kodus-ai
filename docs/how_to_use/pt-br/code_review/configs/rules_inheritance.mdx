...
Por padrão, as Cody Rules são herdadas pela hierarquia:
...
- <a href="/how_to_use/pt-br/code_review/configs/cody_rules">Visão Geral das Cody Rules</a>
...
- <a href="/how_to_use/pt-br/code_review/configs/centralized_config">Configuração Centralizada</a> — gerencie regras como arquivos YAML em `.cody-rules/` em um único repositório.

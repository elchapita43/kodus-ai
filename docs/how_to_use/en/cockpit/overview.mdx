...
<Warning>
  Cockpit requires a paid tier: **Teams or Enterprise on cloud**, or **licensed self-hosted Enterprise**. Unlicensed self-hosted (Community) and free BYOK plans don't include it. Self-hosted Enterprise also needs the [Analytics Worker](/how_to_deploy/en/deploy_codus/analytics_worker) running.
</Warning>
...
- **Codus Review** — how effective Codus's reviews are: implementation rate, severity calibration, negative feedback, and the health of your Cody Rules. This is about Codus itself, and it's where you take action. See [Codus Review](/how_to_use/en/cockpit/codus_review).
...
**Available Metrics:**
- **Codus Review:** Implementation rate (overall, by severity, by category), negative feedback, repository and Cody Rule health

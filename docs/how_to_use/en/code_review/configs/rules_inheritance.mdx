...
By default, Cody Rules are inherited down the hierarchy:
...
- <a href="/how_to_use/en/code_review/configs/cody_rules">Cody Rules Overview</a>
...
- <a href="/how_to_use/en/code_review/configs/centralized_config">Centralized Config</a> — manage rules as YAML files under `.cody-rules/` in a single repository.

...
Por defecto, las Cody Rules se heredan hacia abajo en la jerarquía:
...
- <a href="/how_to_use/es/code_review/configs/cody_rules">Descripción General de Cody Rules</a>
...
- <a href="/how_to_use/es/code_review/configs/centralized_config">Configuración Centralizada</a> — gestiona reglas como archivos YAML bajo `.cody-rules/` en un único repositorio.
